        ...
        <div class="col-md-6 col-sm-12">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col-auto d-none d-lg-block p-2">
                    <img src="data:image/png;base64,<?=$userProfileImage?>" width="150" class="user-image rounded-circle shadow" alt="">
                </div>
                <div class="col p-2 d-flex flex-column ">
                    <strong class="d-inline-block mb-2 text-primary-emphasis">Bienvenido</strong>
                    <?php foreach($userProfile as $k => $v): ?>
...
<?php include_once dirname(__FILE__) . "/FooterSess.php"; ?>
